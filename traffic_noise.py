...
URLS = [
    ...
    "http://mirror.datacenter.by/pub/archlinux/iso/latest/archlinux-x86_64.iso",
    "http://mirror.datacenter.by/pub/almalinux/9/isos/x86_64/AlmaLinux-9-latest-x86_64-dvd.iso"
]
